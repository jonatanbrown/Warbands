  ...
  def self.get_effect_name(effect_id)
    case effect_id
      ...
      when EFFECT_TAKEN_AIM
        'THIS SHOULD NOT BE HERE TAKEN_AIM'
      when EFFECT_RAN_UP
        'THIS SHOULD NOT BE HERE RAN_UP'
      when EFFECT_DEFENSIVE_POSTURE
        'THIS SHOULD NOT BE HERE DEFENSIVE_POSTURE'
      when EFFECT_COVER
        'THIS SHOULD NOT BE HERE COVER'
      when EFFECT_PROTECTED
        'THIS SHOULD NOT BE HERE PROTECTED'
      when EFFECT_SHIELD_WALL
        'THIS SHOULD NOT BE HERE SHIELD_WALL'
      when EFFECT_STUNNED
        'THIS SHOULD NOT BE HERE STUNNED'
    end
  end
